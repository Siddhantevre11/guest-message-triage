...
Groq decommissioned `llama3-8b-8192`. Switched to `llama-3.1-8b-instant`, the current Groq-hosted equivalent in the same size/cost class — no change to the trade-off reasoning above.
